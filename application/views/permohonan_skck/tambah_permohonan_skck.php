<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Tambah Permohonan SKCK</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Dashboard</li>
                <li class="breadcrumb-item active">Data Permohonan SKCK</li>
                <li class="breadcrumb-item active">Tambah Permohonan SKCK</li>
            </ol>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-file mr-1"></i>
                    Tambah Permohonan SKCK
                </div>
                <div class="card-body">
                    <!-- <form action=""> -->
                        <?php echo form_open("permohonan_skck/tambah"); ?>
                        ...
                        <div class="form-group">
                            <label for="input_tujuan">Tujuan</label>
                            <input type="text" class="form-control" placeholder="Isi dengan tujuan membuat permohonan skck" name="input_tujuan" value="<?php echo set_value('input_tujuan');?>">
