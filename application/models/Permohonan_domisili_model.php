...
class Permohonan_domisili_model extends CI_Model
{
	public function view(){
		$this->db->select('permohonan_domisili.*,warga.nik, warga.nama as nama_warga, pegawai.nama as nama_pegawai')
			 ->from('permohonan_domisili')
			 ->join('warga','warga.id_warga = permohonan_domisili.id_warga')
			 ->join('pegawai','pegawai.id_pegawai = permohonan_domisili.id_pegawai');
	...
	public function save(){
		...
		$this->db->insert('permohonan_domisili',$data);
	}
	...
	public function edit($id){
		...
		$this->db->where('id_pdomisili',$id);
		$this->db->update('permohonan_domisili',$data);
	}

	public function delete($id){
		$this->db->where('id_pdomisili',$id);
		$this->db->delete('permohonan_domisili');
	}
}